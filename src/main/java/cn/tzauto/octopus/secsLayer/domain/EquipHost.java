...
public abstract class EquipHost extends Thread implements MsgListener {
    ...
    public String controlState = NormalConstant.CONTROL_LOCAL_ONLINE;
...
//        ConnRegInfo.register(Integer.valueOf(this.deviceId), "active", this.remoteIPAddress, this.remoteTCPPort);
    ...
    public synchronized void setCommState(int commState) {
        ...
        if (commState == 1) {
            ...
            this.sdrReady = true;
//            controlState = NormalConstant.CONTROL_REMOTE_ONLINE;
        }
        if (commState == 0) {
...
//                realTimePara.setVisible(true);
    ...
    public Map findDeviceRecipe() {
        ...
        if (NormalConstant.CONTROL_OFFLINE.equalsIgnoreCase(this.getControlState())) {
    ...
    public void sendS1F15out() {
        ...
        try {
            ...
            if (onlack == 0 || onlack == 2) {
                setControlState(NormalConstant.CONTROL_OFFLINE);
            }
        } catch (Exception e) {
            logger.error("Exception:", e);
        }
    ...
    public void sendS1F17out() {
        ...
        try {
            ...
            if (onlack == 0 || onlack == 2) {
                setControlState(NormalConstant.CONTROL_REMOTE_ONLINE);
            }
            data = null;
        } catch (Exception e) {
            logger.error("Exception:", e);
    ...
    public void sendS2F15out(String ecid, String ecv) {
        ...
        try {
            ...
            if (ack[0] == 0 || ack[0] == 2) {
                setControlState(NormalConstant.CONTROL_LOCAL_ONLINE);
            }
        } catch (Exception e) {
            logger.error("Exception:", e);
        }
