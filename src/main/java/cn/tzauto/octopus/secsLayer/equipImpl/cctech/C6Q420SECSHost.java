...
public class C6Q420SECSHost extends EquipHost {

    private static final long serialVersionUID = 1L;

    private static Logger logger = Logger.getLogger(C6Q420SECSHost.class);

    private boolean checkNameFlag = true;
    private boolean checkParaFlag = true;
    private boolean canDownladMap = true;

    public C6Q420SECSHost(String devId, String IpAddress, int TcpPort, String connectMode, String deviceType, String deviceCode) {
    ...
    public Object clone() {
        C6Q420SECSHost newEquip = new C6Q420SECSHost(deviceId,
                this.iPAddress,
