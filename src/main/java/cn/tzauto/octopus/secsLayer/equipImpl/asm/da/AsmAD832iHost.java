...
public class AsmAD832iHost extends EquipHost {
    ...
    public AsmAD832iHost(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//                    sendS1F17out();
                ...
                if (msg.getMsgTagName() != null && msg.getMsgTagName().contains("s14f1in")) {
                    ...
                    String stripMapData = "";
                    try {
                        stripMapData = (String) ((SecsItem) msg.get("MapData")).getData();
                    } catch (Exception e) {
                    }
                    if (stripMapData.contains("BinCode")) {
...
//        }
    ...
    @Override
    public Object clone() {
        AsmAD832iHost newEquip = new AsmAD832iHost(deviceId, this.equipId,
