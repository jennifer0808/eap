package cn.tzauto.octopus.secsLayer.equipImpl.giga;
...
import cn.tzauto.octopus.secsLayer.resolver.giga.GIGA690RecipeUtil;
...
public class GIGA690Host extends EquipHost {

    private static final long serialVersionUID = -8427516257654563776L;
    private static final Logger logger = Logger.getLogger(GIGA690Host.class.getName());

    public GIGA690Host(String devId, String IpAddress, int TcpPort, String connectMode, String deviceType, String deviceCode) {
...
//        StripMapUpCeid = 15339L;
    ...
    @Override
    public Object clone() {
        GIGA690Host newEquip = new GIGA690Host(deviceId,
                this.iPAddress,
...
//    }
    ...
    public void processS6F11in(DataMsgMap data) {
        ...
        try {
            ...
            } else if (ceid == 1 || ceid == 2 || ceid == 3 || ceid == 8
