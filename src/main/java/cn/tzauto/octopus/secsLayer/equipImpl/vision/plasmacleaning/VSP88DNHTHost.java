...
import cn.tzauto.octopus.common.resolver.vision.Vision88DRecipeUtil;
...
//                                this.startCheckRecipePara(downLoadGoldRecipe.get(0));
    ...
    protected void processS6F11stripIdRead(MsgDataHashtable data) {
        ...
        String result = AxisUtility.plasma88DService(deviceCode, stripId, funcType);
    ...
    public Map sendS7F5out(String recipeName) {
        ...
        if (data != null && !data.isEmpty()) {
            ...
            if (paraMap != null && !paraMap.isEmpty()) {
                recipeParaList = Vision88DRecipeUtil.transferFromDB(recipePath, deviceType);
            } else {
