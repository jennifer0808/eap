...
public class LMC3200G3Host extends EquipHost {
    ...
    private static final Logger logger = Logger.getLogger(LMC3200G3Host.class.getName());

    public LMC3200G3Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//            recipeParaList = TowaRecipeUtil.transferTowaRcpFromDB(deviceType, ppbody);
    ...
    @Override
    public Object clone() {
        LMC3200G3Host newEquip = new LMC3200G3Host(deviceId, this.equipId,
