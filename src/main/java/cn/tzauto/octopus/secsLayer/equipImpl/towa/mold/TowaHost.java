...
//                    sendS5F3out(true);
                ...
                } else if (msg.getMsgTagName() != null && msg.getMsgTagName().equalsIgnoreCase("s6f112dcodereview")) {
...
//                } else {
    ...
    protected void processS6f11StripIDReview(MsgDataHashtable data) {
        Long pressNoInt = 0L;
        String pressNo = "";
        try {
...
//    }
    @Override
    public Object clone() {
        TowaHost newEquip = new TowaHost(deviceId, this.equipId,
    ...
    private void sendS2f33outMulti(long reportId, long svid0, long svid1, long svid2, long svid3, long svid4) {
        MsgDataHashtable s2f33out = new MsgDataHashtable("s2f33outmulti", mli.getDeviceId());
