...
public class HT9045HWHost extends EquipHost {
    ...
    public HT9045HWHost(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//                realTimePara.setVisible(true);
    ...
    @Override
    public Object clone() {
        HT9045HWHost newEquip = new HT9045HWHost(deviceId, this.deviceCode,
