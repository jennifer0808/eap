...
//                    }
                ...
                if (cfgline.contains("Flat_Notch")) {
                    continue;
                }
                if ("".equals(cfgline)) {
                    continue;
...
//            resultMap.put("BinList", bins);
    ...
    public static void main(String[] args) {
        //  Map map = getWaferFileInfo("", "90");

        //transferArgs1(transferArgs1((long[]) map.get("BinList"), 53, 58), 58, 53);
//        transferAngle((long[]) map.get("BinList"), "90");
        System.out.println("SigmaPlusWaferTransfer.main()" + getPath("T19M35.00-03.TXT"));
    }
