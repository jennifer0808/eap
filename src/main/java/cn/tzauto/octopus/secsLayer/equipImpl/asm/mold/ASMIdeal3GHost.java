...
import cn.tzauto.octopus.common.resolver.asm.ASMIdeal3GRecipeUtil;
...
//    public void processS1F4statein(MsgDataHashtable data) {
//        if (data == null) {
//            return;
//        }
...
//    }
//
//    public void processS1F4recipein(MsgDataHashtable data) {
//        if (data == null) {
//            return;
//        }
//        long PPExecName = 0l;
...
//
//        MsgDataHashtable s2f41out = new MsgDataHashtable("s2f41muiltout", mli.getDeviceId());
...
//        MsgDataHashtable s7f1multi = new MsgDataHashtable("s7f1multiout", mli.getDeviceId());
//        s7f1multi.setTransactionId(mli.getNextAvailableTransactionId());
...
//        try {
//            mli.sendPrimaryWsetMessage(s7f1multi);
//        } catch (Exception e) {
//            logger.error("Exception:", e);
//        }
//    }
...
//        MsgDataHashtable s7f3multi = new MsgDataHashtable("s7f3multiout", mli.getDeviceId());
//        s7f3multi.setTransactionId(mli.getNextAvailableTransactionId());
//        SecsItem secsItemmain = new SecsItem();
//        secsItemmain.setFormatCode(FormatCode.SECS_LIST);
//        ArrayList listmain = new ArrayList();
//        for (int i = 0; i < l.size(); i++) {
...
//        try {
//            mli.sendPrimaryWsetMessage(s7f3multi);
//        } catch (Exception e) {
//            logger.error("Exception:", e);
//        }
//    }
...
//        mli = equipHost.getMli();
//
//        deviceCode = equipHost.getDeviceCode();
//        MsgDataHashtable s7f17outmuilt = new MsgDataHashtable("s7f17outmuilt", mli.getDeviceId());
//        s7f17outmuilt.setTransactionId(mli.getNextAvailableTransactionId());
//        for (int i = 0; i < ppid.size(); i++) {
//            s7f17outmuilt.put("ProcessprogramID" + i, ppid.get(i));
//        }
//        try {
//            msgdata = mli.sendPrimaryWsetMessage(s7f17outmuilt);
//        } catch (Exception e) {
//            logger.error("Exception:", e);
//        }
...
//        UiLogUtil.appendLog2SeverTab(deviceCode, "UPH参数为:" + mqMap);
    ...
    public Object clone() {
        ASMIdeal3GHost newEquip = new ASMIdeal3GHost(deviceId, this.equipId,
