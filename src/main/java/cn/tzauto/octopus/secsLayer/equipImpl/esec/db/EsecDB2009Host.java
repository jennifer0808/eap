...
public class EsecDB2009Host extends EquipHost {
    ...
    private static final Logger logger = Logger.getLogger(EsecDB2009Host.class.getName());
    ...
    public EsecDB2009Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//                processS14F1in(data);
    ...
    public String initRptPara() {
        try {
            ...
            sendS2f33out(100000L, 20002L);
            sendS2f33out(100001L, 20004L);
...
//            long FileFrameRotation = DataMsgMap.getSingleNumber("FileFrameRotation");
    ...
    @Override
    public Object clone() {
        EsecDB2009Host newEquip = new EsecDB2009Host(deviceId, this.deviceCode,
