...
public class DT550AHost extends EquipHost {
    ...
    public DT550AHost(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//            }
    ...
    @Override
    public Object clone() {
        DT550AHost newEquip = new DT550AHost(deviceId, this.deviceCode,
