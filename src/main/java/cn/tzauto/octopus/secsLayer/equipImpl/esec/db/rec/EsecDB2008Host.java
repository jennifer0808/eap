...
public class EsecDB2008Host extends EquipHost {
    ...
    public EsecDB2008Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//            }
    ...
    @Override
    public Object clone() {
        EsecDB2008Host newEquip = new EsecDB2008Host(deviceId, this.deviceCode,
