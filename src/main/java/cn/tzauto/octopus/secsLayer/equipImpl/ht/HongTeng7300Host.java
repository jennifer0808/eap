...
public class HongTeng7300Host extends EquipHost {
    ...
    public HongTeng7300Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//        if(ppbody.equalsIgnoreCase("OK")){}
        ...
        try {
            recipeParaList = HongTengRecipeUtil.transferRcpFromDB(recipePath,deviceType);
...
//        s1f13out.put("SoftRev", SoftRev);
    ...
    @Override
    public Object clone() {
        HongTeng7300Host newEquip = new HongTeng7300Host(deviceId, this.deviceCode,
