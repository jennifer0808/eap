...
public class GIS126Host extends EquipHost {
    ...
    private static final Logger logger = Logger.getLogger(GIS126Host.class.getName());

    public GIS126Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//            recipeParaList = TowaRecipeUtil.transferTowaRcpFromDB(deviceType, ppbody);
    ...
    @Override
    public Object clone() {
        GIS126Host newEquip = new GIS126Host(deviceId, this.equipId,
