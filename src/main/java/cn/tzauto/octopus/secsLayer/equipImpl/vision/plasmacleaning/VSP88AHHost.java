...
public class VSP88AHHost extends EquipHost {
    ...
    public VSP88AHHost(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//        changeEqptControlStateAndShowDetailInfo("LOCAL");
    ...
    public Map sendS7F5out(String recipeName) {
        ...
        if (data != null && !data.isEmpty()) {
            ...
            //Recipe解析   
            Map paraMap = VisionRecipeUtil.transferFromFile(recipePath);
    ...
    public Map sendS7F17out(String recipeName) {
        ...
        try {
            ...
            logger.debug("Request delete recipe " + recipeName + " at " + deviceCode);
...
// </editor-fold> 
    ...
    @Override
    public Object clone() {
        VSP88AHHost newEquip = new VSP88AHHost(deviceId, this.equipId,
    ...
    public void initRemoteCommand() {
        throw new UnsupportedOperationException("Not supported yest.");
    }

    private void initRptPara() {
//        sendS7F17out("DEFAULT");
//        sendS7F1out("E:\\RECIPE", "QFNTest");
//        sendS7F3out("E:\\RECIPE", "QFNTest");
//        sendS7F5out("BGA.pls");
        sendS5F3out(true);
//        sendS1F11out();
//        sendS2F41outPPselect("QFN");
        sendS2f33stripout();
