...
public class COVERLAYATTACH2000175Z1Host extends EquipHost {

    private static final long serialVersionUID = -8427516257654563776L;
    private static final Logger logger = Logger.getLogger(COVERLAYATTACH2000175Z1Host.class.getName());
    ...
    @Override
    public Object clone() {
        COVERLAYATTACH2000175Z1Host newEquip = new COVERLAYATTACH2000175Z1Host(deviceId,
                this.iPAddress,
