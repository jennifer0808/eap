...
//                }
    ...
    public Map sendS2F41outStart(String batchName) {
        ...
        cplist.add("ACTION");
        cplist.add("BATCH-TO-PROCESS");
        cplist.add("CARRIER-COUNT");
        cplist.add("INPUT-TRAY-MAP");
        cplist.add("TRAY-REPORTING");

        byte hcack = -1;
        try {
            DataMsgMap data = activeWrapper.sendS2F41out(rcmd, cplist, cpMap, cpNameFormatMap, cpValueFormatMap);
