...
public class AsmAD838Host extends EquipHost {
    ...
    private static final Logger logger = Logger.getLogger(AsmAD838Host.class);
...
//                processS14F1in(data);   
    ...
    private void initRptPara() throws IOException, BrokenProtocolException, T6TimeOutException, T3TimeOutException,  InterruptedException {
        sendS1F1out();
