...
public class AsmAD8312Host extends EquipHost {
    ...
    public AsmAD8312Host(String devId, String equipmentId, String smlFileFullPath, String localIpAddress,
...
//                    sendS1F11out();
                ...
                } else if (msg.getMsgTagName() != null && msg.getMsgTagName().contains("s6f11EquipStatusChange")) {
...
//            recipeParaList = AsmAD8312RecipeUtil.transferRcpFromDB(recipePath, deviceType);
            //Recipe解析      
            recipeParaList = AsmAD8312RecipeUtil.transferRecipeParaFromDB(recipePath, deviceType);
        }
...
//        }
    ...
    @Override
    public Object clone() {
        AsmAD8312Host newEquip = new AsmAD8312Host(deviceId, this.equipId,
