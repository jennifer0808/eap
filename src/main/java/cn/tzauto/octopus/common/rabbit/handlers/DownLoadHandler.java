...
public class DownLoadHandler implements MessageHandler {
    ...
    public void handle(HashMap<String, String> msgMap) throws IOException, HsmsProtocolNotSelectedException, T6TimeOutException, BrokenProtocolException, T3TimeOutException, ItemIntegrityException, StreamFunctionNotSupportException, MessageDataException, InterruptedException {
        ...
        recipeParaList = (List<RecipePara>) JsonMapper.String2List(msgMap.get("recipePara"), RecipePara.class);
        attachs = (List<Attach>) JsonMapper.String2List(msgMap.get("arAttach"), Attach.class);
        if (msgMap.get("recipeGold") != null) {
            recipeGold = (Recipe) JsonMapper.fromJsonString(msgMap.get("recipeGold"), Recipe.class);
            recipeParaListGold = (List<RecipePara>) JsonMapper.String2List(msgMap.get("recipeParaGold"), RecipePara.class);
            attachGolds = (List<Attach>) JsonMapper.String2List(msgMap.get("arAttachGold"), Attach.class);
        }
