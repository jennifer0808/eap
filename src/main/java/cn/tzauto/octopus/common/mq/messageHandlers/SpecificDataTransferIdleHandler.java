 ...
 * @author luosy
 */
public class SpecificDataTransferIdleHandler implements MessageHandler {

    private static final Logger logger = Logger.getLogger(SpecificDataTransferIdleHandler.class);
    ...
    public void handle(Message message) {
        ...
        try {
            ...
            Map resultMap = GlobalConstants.stage.hostManager.getSpecificDataTemp(deviceInfo.getDeviceId(), dataIdMap);
