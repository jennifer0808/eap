 ...
 * @author luosy
 */
public class TowaISECSRecipeEdit {

    public static void main(String[] args) {
        List<String> edits = TowaISECSRecipeEdit.getUniqueRecipeParaMap("D:\\RECIPE\\FCC0130-0.50-AO-A.rsp");
        TowaISECSRecipeEdit.writeRecipeFile(edits, "D:\\RECIPE\\FCC0130-0.50-AO-A.rsp");
    }
