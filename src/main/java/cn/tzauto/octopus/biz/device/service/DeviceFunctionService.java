...
public class DeviceFunctionService extends BaseService {
    ...
    private static Logger logger = Logger.getLogger(DeviceFunctionService.class);
    ...
    public DeviceFunctionService(SqlSession sqlSession) {
        super(sqlSession);
