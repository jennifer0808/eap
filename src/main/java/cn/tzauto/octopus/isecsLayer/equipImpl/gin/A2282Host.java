...
public class A2282Host extends EquipModel {

    private static final Logger logger = Logger.getLogger(A2282Host.class.getName());

    public A2282Host(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
...
//            result = iSecsHost.executeCommand(cmd);
    ...
    @Override
    public Object clone() {
        A2282Host newHost = new A2282Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
