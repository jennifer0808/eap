...
public class SytAtssRoHost extends EquipModel {

    private Logger logger = Logger.getLogger(SytAtssRoHost.class);
    ...
    public SytAtssRoHost(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
        ...
        try {
            in = SytAtssRoHost.class.getResourceAsStream("sytAtssRoErr.json");
    ...
    @Override
    public Object clone() {
        SytAtssRoHost sytAtssRoHost = new SytAtssRoHost(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
