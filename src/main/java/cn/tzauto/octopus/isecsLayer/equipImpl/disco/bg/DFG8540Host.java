...
public class DFG8540Host extends EquipModel {
    ...
    @Override
    public Object clone() {
        DFG8540Host newEquip = new DFG8540Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
    ...
    public Map getSpecificData(Map<String, String> dataIdMap) {
        ...
        return this.getEquipMonitorPara();//this.iSecsHost.readJasonData(dataIdMap);
    }
}
