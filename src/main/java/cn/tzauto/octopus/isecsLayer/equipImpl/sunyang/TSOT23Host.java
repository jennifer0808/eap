...
public class TSOT23Host extends EquipModel {

    private Logger logger = Logger.getLogger(TSOT23Host.class);
    ...
    public TSOT23Host(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
        ...
        try {
            in = TSOT23Host.class.getResourceAsStream("sytAtssRoErr.json");
    ...
    @Override
    public Object clone() {
        TSOT23Host sytAtssRoHost = new TSOT23Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
