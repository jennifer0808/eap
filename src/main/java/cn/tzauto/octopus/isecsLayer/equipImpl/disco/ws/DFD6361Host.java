...
public class DFD6361Host extends EquipModel {
    ...
    private static Logger logger = Logger.getLogger(DFD6361Host.class.getName());
...
//                attach.setAttachPath(ftpRecipePath + recipeName + ".DFD_V" + recipe.getVersionNo());
    ...
    @Override
    public Object clone() {
        DFD6361Host newEquip = new DFD6361Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
