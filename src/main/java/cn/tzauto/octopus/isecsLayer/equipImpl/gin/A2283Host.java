...
public class A2283Host extends EquipModel {

    private static final Logger logger = Logger.getLogger(A2283Host.class.getName());

    public A2283Host(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
...
//            result = iSecsHost.executeCommand(cmd);
    ...
    @Override
    public Object clone() {
        A2283Host newHost = new A2283Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
