...
public class VSP88DIIHost extends EquipModel {

    private Logger logger = Logger.getLogger(VSP88DIIHost.class);
    ...
    public VSP88DIIHost(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
    ...
    public Map uploadRecipe(String recipeName) {
        ...
        String cmd = "ftp " + localftpip + " " + ftpUser + " " + ftpPwd + " \"" + equipRecipePath + "\" \"" + getClientFtpRecipeRelativePath(recipeName) + "\" \"mput $" + recipeName + ".*$";
        ...
        try {
            ZipUtil.toZip(true, new File(clientFtpRecipeRelativePath).listFiles(), new FileOutputStream(clientFtpRecipeRelativePath + recipeName + ".zip"));
        ...
        }, new File(getClientFtpRecipeAbsolutePath(recipeName) + recipeName), recipeTemplates, false));
    ...
    public String deleteRecipe(String recipeName) {
        ...
        String cmd = "dos $del /q \"" + equipRecipePath + recipeName +  ".*\"$";
        synchronized (iSecsHost.iSecsConnection.getSocketClient()) {
            iSecsHost.executeCommand(cmd);
        }
        return "0";
    ...
    public String getEquipStatus() {
        ...
        synchronized (iSecsHost.iSecsConnection.getSocketClient()) {
            try {
                List<String> errorList = iSecsHost.executeCommand("readrectcolor 109 43 128 38");
    ...
    @Override
    public Object clone() {
        VSP88DIIHost vsp88DIIHost = new VSP88DIIHost(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
        vsp88DIIHost.startUp = startUp;
        clear();
        return vsp88DIIHost;
    }
