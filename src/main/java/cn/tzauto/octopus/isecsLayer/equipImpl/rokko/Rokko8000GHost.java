...
public class Rokko8000GHost extends EquipModel {

    private Logger logger = Logger.getLogger(Rokko8000SHost.class);

    public Rokko8000GHost(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
    ...
    public Map getEquipRecipeList() {
        synchronized (
                iSecsHost.iSecsConnection.getSocketClient()) {
            iSecsHost.executeCommand("");
        }
        return null;
    }
    ...
    @Override
    public Object clone() {
        Rokko8000GHost newEquip = new Rokko8000GHost(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
