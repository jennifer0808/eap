...
public class FSOT23Host extends EquipModel {

    private Logger logger = Logger.getLogger(FSOT23Host.class);
    ...
    public FSOT23Host(String devId, String remoteIpAddress, int remoteTcpPort, String deviceType, String iconPath, String equipRecipePath) {
        ...
        try {
            in = FSOT23Host.class.getResourceAsStream("sytAtssRoErr.json");
    ...
    @Override
    public Object clone() {
        FSOT23Host sytAtssRoHost = new FSOT23Host(deviceId, remoteIPAddress, remoteTCPPort, deviceType, iconPath, equipRecipePath);
