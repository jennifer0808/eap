...
//                            CommonUtil.alert("删除失败");
    ...
    @FXML
    private void saveExited() {
        BTN_save.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void saveMoved() {
        BTN_save.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void savePressed() {
        BTN_save.setStyle("-fx-background-color: #F9A125;");
    }

    @FXML
    private void saveReleased() {
        BTN_save.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void queryExited() {
        BTN_query.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void queryMoved() {
        BTN_query.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void queryPressed() {
        BTN_query.setStyle("-fx-background-color: #F9A125;");
    }

    @FXML
    private void queryReleased() {
        BTN_query.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void viewExited() {
        BTN_view.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void viewMoved() {
        BTN_view.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void viewPressed() {
        BTN_view.setStyle("-fx-background-color: #F9A125;");
    }
    ...
    @FXML
    private void downloadExited() {
        BTN_download.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void downloadMoved() {
        BTN_download.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void downloadPressed() {
        BTN_download.setStyle("-fx-background-color: #F9A125;");
    }

    @FXML
    private void downloadReleased() {
        BTN_download.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void uploadExited() {
        BTN_upload.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void uploadMoved() {
        BTN_upload.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void uploadPressed() {
        BTN_upload.setStyle("-fx-background-color: #F9A125;");
    }

    @FXML
    private void uploadReleased() {
        BTN_upload.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void deleteExited() {
        BTN_delete.setStyle("-fx-background-color: #0081CC;");
    }

    @FXML
    private void deleteMoved() {
        BTN_delete.setStyle("-fx-background-color: #FBC372;");
    }

    @FXML
    private void deletePressed() {
        BTN_delete.setStyle("-fx-background-color: #F9A125;");
    }

    @FXML
    private void deleteReleased() {
        BTN_delete.setStyle("-fx-background-color: #0081CC;");
    }
