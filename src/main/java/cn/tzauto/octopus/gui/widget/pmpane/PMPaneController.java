 ...
 */
package cn.tzauto.octopus.gui.widget.pmpane;
 ...
 * @author luosy
 */
public class PMPaneController implements Initializable {
    private static final Logger logger = Logger.getLogger(PMPaneController.class.getName());
    @FXML
    ...
    public PMPaneController(String dc) {
        this.deviceCode = dc;
        stage.setTitle("设备保养");
        stage.setAlwaysOnTop(true);
        stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
...
//        this.deviceCode = deviceCode;
        ...
        try {
            ...
            root = FXMLLoader.load(getClass().getClassLoader().getResource("PMPane.fxml"), resourceBundle);
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        Image image = new Image(PMPaneController.class.getClassLoader().getResourceAsStream("logoTaiZhi.png"));
