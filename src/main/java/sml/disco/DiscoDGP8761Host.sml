...
S1F3 = s1f3CassUse OUTPUT W
 <L [2]
    ...
    <U4 1005> 
>.
S1F3 = s1f3DISCODGP8761inlineRcpPara OUTPUT W
<L[30] 
<U4 [1]>=Data0
<U4 [1]>=Data1
<U4 [1]>=Data2
...
<L [3]
	...
	<L [2]
		<L [2]
			<U4[1] > = UserWaferSizeId1
			<L [1]
				<U4[1] > = UserWaferSize
			>
		>
		<L [2]
			<U4[1] > = UserWaferSizeId2
			<L [1]
				<U4[1] > = UserWaferSize2
			>
		>
...
<L[2]
    ...
    >
>.
S2F41  = s2f41outPPSelectDFM OUTPUT W
<L[2]
    <A 'PP-SELECT'> 
    <L[1]
        <L[2]
