...
S6F11 = s6f11StripMapUpload  INPUT W
<L [3]
       <U2 [3] >                              = DataID
       <U4 [3] >                              = CollEventID
       <L [1]
